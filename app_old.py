...
def get_gemini_client(): 
    ...
    user_key = request.headers.get("X-Gemini-Key") or request.form.get("api_key") 
    if not user_key: 
        return None 
...
def download_pdf(): 
    ...
    with tempfile.TemporaryDirectory() as tmpdir: 
        ...
        PDFLATEX = r"C:\Users\aures\AppData\Local\Programs\MiKTeX\miktex\bin\x64\pdflatex.exe" 
 
        # ✅ Overleaf-like behavior (2 passes, ignore errors) 
        for _ in range(2): 
            subprocess.run( 
